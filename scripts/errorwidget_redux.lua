...
env.AddClassPostConstruct("widgets/scripterrorwidget",
        ...
        --[[     table.insert(buttons, 1,
    {
        ...
        self.documentsbutton = self.root:AddChild(TEMPLATES.IconButton("images/button_icons2.xml", "local_filter.tex",
        ...
        for k, v in pairs(self.menu_new.items) do
            ...
            v:SetTextures("images/global_redux.xml", "button_carny_xlong_normal.tex", "button_carny_xlong_hover.tex",
